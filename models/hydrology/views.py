...
description = "<p>The hydrological cycle is the largest movement of any substance on Earth with most of the movement" \
              " occurring through precipitation and evaporation. Controlled by the sun's radiation, water is" \
              " evaporated from the ocean and land surface where it moves with the winds in the atmosphere and" \
...
subsurfaceflow_description = "<p>Baseflow is the portion of streamflow that comes from subsurface groundwater" \
                             " effluent.</p>" \
...
evapotranspiration_description = "<p>Evapotranspiration is the combination of water loss through a phase change by" \
                                 ...
                                 " surfaces, and plant surfaces.  Controlled by temperature, solar radiation," \
                                 " humidity, wind, and vegetation.</p>"
...
surfacerunoff_description = "<p>Surface runoff is classified as precipitation that does not infiltrate into the soil" \
                            " and runs across the surface into streams, rivers, and lakes. Depends on soil moisture," \
                            " impervious areas, hillslope, and storm intensity.  Affects flooding, sediment" \
                            " transport, erosion, and chemical concentrations.</p>" \
