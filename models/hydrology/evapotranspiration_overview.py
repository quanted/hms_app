...
class Evapotranspiration:
    ...
    algorithms = {
        ...
        "Hamon": "The Hamon algorithm calculates Potential Evapotranspiration using temperature data obtained from "
                 "NLDAS or GLDAS. The following equations are used for the calculation of Hamon PET, where H is the number of daylight hours and T<sub>mean</sub> is the average daily temperature: <img src='/hms/static/images/Hamon.png' alt='Hamon equations' style=''> The following table shows all parameters used and produced by the algorithm along "
    ...
    input_parameters = [
        ...
        ["Output Data Format", "String", "Format of the returned numeric values.",
