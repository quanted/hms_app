"""
Precipitation Overview Details
"""
...
algorithms = {
    "NCDC Precipitation": "The National Climatic Data Center (NCDC) provides precipitation data recorded at rain "
                          ...
                          "station and the station number. Some stations have been recording data as far back as 1901"
                          " to present day.",
    "NLDAS Precipitation": "The North American Land Data Assimilation System (NLDAS) combines North American radar "
                           "data and satellite data from CMORPH. NLDAS has an hourly time step on a 0.125 -degree grid"
                           " of North America and has a maximum time lag of four days for data retrieval. Data is "
                           "available from January 2, 1979 to present",
